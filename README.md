...
| :--- | :--- | :--- | :--- | :--- |
| **01** | **⚡ Valence Microsystems** | *Technical Metrology & Silicon Scrubber* | 400vh Scroll-bound 60fps video scrubbing, mathematical typography, interactive die explorer, substrate metrology | [`/valence/`](./valence/) |
...
Run the local server from the root directory:
